...
/*
--Estas facturas deben ingresarse mediante transacciones, por lo tanto se verá afectado el stock de cada producto
...
-- Otro ejemplo de transacciones. Aún se podría pulir más, por ej. utilizando la función SUM en los totales de c/producto
...
commit;
*/
--falta insertar inicialmente a la factura sólo el id y el cliente, lo demás null.
--luego de insertar valores a factura_producto, realizar update a factura con los valores faltantes faltantes
--para hacer lo anterior. primero deberé realizar delete a los datos ya ingresados en ambas tablas involucradas
